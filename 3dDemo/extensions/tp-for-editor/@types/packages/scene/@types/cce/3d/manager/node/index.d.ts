import { IProperty, INode, CreateNodeOptions } from '../../../../public';
import EventEmitter from '../../../../../source/script/public/EventEmitter';
...
export declare class NodeManager extends EventEmitter implements ISceneEvents {
     ...
     * @param {String} uuid
     */
    queryDump(uuid: string): INode | import("../../../../public").IScene | null;
    /**
     * 查询一个节点，并返回该节点的 dump 数据
     * 不论节点是否被删除
     * @param {String} uuid
     */
    queryDumpAtAll(uuid: string): INode | import("../../../../public").IScene | null;
    /**
     * 查询当前场景的节点树信息
