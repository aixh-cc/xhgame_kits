...
export declare class NodeUtils {
    ...
    getRaycastResults(camera: renderer.scene.Camera, x: number, y: number, mask?: number): import("../../../source/script/utils/raycast").IRaycastResult[];
    getRaycastResultsForSnap(camera: renderer.scene.Camera, x: number, y: number, mask?: number): import("../../../source/script/utils/raycast").IRaycastResult[];
