...
import { IAnimationClipData, IPropCustomData, IKeyframe, ICurveData } from '../../../../../source/script/3d/manager/animation/type-defines';
...
export declare class EditorAnimationCurve extends EditorAnimationCurveBase {
     ...
     * @param frame
     */
    getPropValueAtFrame(frame: number): Promise<import("../../../../public").IProperty | null>;
}
