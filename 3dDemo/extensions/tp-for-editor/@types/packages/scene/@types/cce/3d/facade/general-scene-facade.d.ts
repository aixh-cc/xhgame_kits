...
import { CreateComponentOptions, CreateNodeOptions, CutNodeOptions, ExecuteComponentMethodOptions, ExecuteSceneScriptMethodOptions, IAnimOperation, MoveArrayOptions, PasteNodeOptions, QueryClassesOptions, RemoveArrayOptions, RemoveComponentOptions, RemoveNodeOptions, SetPropertyOptions, EditorCameraInfo } from '../../../public';
import { IAniResultBase, IAssetMeta, IChangeNodeOptions, IOptionBase, ISceneUndoOptions } from '../../../private';
import { ISceneFacadeState, SceneModeType } from '../../../../source/script/3d/facade/scene-facade-state-interface';
import SceneProxy from '../../../../source/script/3d/manager/scene/proxy/scene-proxy';
...
import { TransformToolDataCoordinateType, TransformToolDataPivotType, TransformToolDataToolNameType } from '../../../../source/script/public/gizmos/utils/transform-tool-data';
import { IAssetInfo } from '../../../../../asset-db/@types/protected';
import { SceneUndoCommandID, ISceneUndoManager } from '../../../../source/script/export/undo/index';
export declare class GeneralSceneFacade implements ISceneFacadeState, LightProbeEditModeListener {
    protected _sceneMgr: import("../../../../source/script/3d/manager/scene/scene-manager").default;
    protected _cameraMgr: import("../../../../source/script/3d/manager/camera").Camera;
    protected _nodeMgr: import("../../../../source/script/3d/manager/node").NodeManager;
    protected _compMgr: import("../../../../source/script/3d/manager/component").CompManager;
    protected _assetMgr: import("../../../../source/script/3d/manager/asset").AssetManager;
    protected _gizmoMgr: import("../../../../source/script/public/gizmos/3d/gizmo-manager").GizmoManager;
    protected _materialPreviewMgr: import("../../../../source/script/3d/manager/material-preview").MaterialPreview;
    protected _miniPreviewMgr: import("../../../../source/script/3d/manager/mini-preview").MiniPreview;
    protected _scriptMgr: import("../../../../source/script/3d/manager/scripts").ScriptManager;
    protected _previewMgr: import("../../../../source/script/3d/manager/preview").PreviewManager;
    protected _animationMgr: import("../../../../source/script/3d/manager/animation").AnimationManager;
    protected _selectionMgr: import("../../../../source/script/3d/manager/selection").SceneSelection;
    protected _effectMgr: import("../../../../source/script/3d/manager/effects").EffectManager;
    protected _terrainMgr: import("../../../../source/script/3d/manager/terrain").TerrainManager;
    protected _prefabMgr: import("../../../../source/script/3d/manager/prefab").PrefabManager;
    protected _engineMgr: import("../../../../source/script/3d/manager/engine").EngineManager;
    protected _pluginMgr: import("../../../../source/script/3d/manager/plugin").PluginManager;
    protected _uiMgr: import("../../../../source/script/3d/manager/ui").UIManager;
    protected _particleMgr: import("../../../../source/script/3d/manager/particle").ParticleManager;
    protected _lodMgr: import("../../../../source/script/3d/manager/lod").LODManager;
    protected _modelPreviewMgr: import("../../../../source/script/3d/manager/model-preview").ModelPreview;
    protected _meshPreviewMgr: import("../../../../source/script/3d/manager/mesh-preview").MeshPreview;
    protected _physics2DMgr: import("../../../../source/script/3d/manager/physics-2d").Physics2DManager;
    protected _particle2DMgr: import("../../../../source/script/3d/manager/particle-2d").Particle2DManager;
    ...
    queryComponent(uuid: string): Promise<import("../../../public").IComponent | null>;
    ...
    queryAnimationNodeEditInfo(uuid: string): import("../../../public").IAniEditInfo;
    queryAuxiliaryCurves(clipUuid: string): Promise<Record<string, import("../../../public").IPropCurveDumpData>>;
