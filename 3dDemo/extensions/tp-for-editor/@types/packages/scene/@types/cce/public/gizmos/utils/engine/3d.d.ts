...
import { IAddMeshToNodeOption, ICreateMeshOption, IMeshPrimitive, DynamicMeshPrimitive } from '../../../../../../source/script/public/gizmos/defines';
import EngineInterface from '../../../../../../source/script/public/gizmos/utils/engine/engine-interface';
...
export declare class Engine3D implements EngineInterface {
    ...
    getBoundingBox(component: Component): import("../../../../../../source/script/utils/aabb").default | geometry.AABB | null;
