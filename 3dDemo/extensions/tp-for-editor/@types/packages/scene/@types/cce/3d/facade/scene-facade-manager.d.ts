import { SetPropertyOptions, MoveArrayOptions, RemoveArrayOptions, CutNodeOptions, PasteNodeOptions, CreateNodeOptions, RemoveNodeOptions, CreateComponentOptions, RemoveComponentOptions, ExecuteComponentMethodOptions, IAnimOperation, ExecuteSceneScriptMethodOptions, UnitTestInfo, QueryClassesOptions } from '../../../public';
import { AnimationOperationOptions, EditorCameraInfo, IChangeNodeOptions, ISceneUndoOptions } from '../../../private';
import ISceneFacade from '../../../scene-facade-interface';
import cameraMgr from '../../../../source/script/3d/manager/camera';
import nodeMgr from '../../../../source/script/3d/manager/node';
import compMgr from '../../../../source/script/3d/manager/component';
import gizmoMgr from '../../../../source/script/3d/manager/gizmos';
import assetMgr from '../../../../source/script/3d/manager/asset';
import prefabMgr from '../../../../source/script/3d/manager/prefab';
import selectionMgr from '../../../../source/script/3d/manager/selection';
import pluginMgr from '../../../../source/script/3d/manager/plugin';
import type PreviewPlay from '../../../../source/script/3d/manager/preview-play';
import terrainMgr from '../../../../source/script/3d/manager/terrain';
import { engineManager as engineMgr } from '../../../../source/script/3d/manager/engine';
import operationMgr from '../../../../source/script/public/operation';
import shortcutMgr from '../../../../source/script/3d/manager/shortcut';
import { Node, Component } from 'cc';
import sceneMgr from '../../../../source/script/3d/manager/scene';
import previewPlay from '../../../../source/script/3d/manager/preview-play';
import scriptMgr from '../../../../source/script/3d/manager/scripts';
import effectMgr from '../../../../source/script/3d/manager/effects';
import animationMgr from '../../../../source/script/3d/manager/animation';
import DumpEncode from '../../../../source/script/export/dump/encode';
import DumpDecode from '../../../../source/script/export/dump/decode';
import DumpUtils from '../../../../source/script/export/dump/utils';
import * as cc from 'cc';
import { previewMgr } from '../../../../source/script/3d/manager/preview';
import { SceneUndoCommandID } from '../../../../source/script/export/undo';
...
declare class SceneFacadeManager implements ISceneFacade {
    ...
    queryTransformSnapConfigs(): import("../../../../source/script/public/gizmos/utils/transform-tool-data").ISnapConfigData;
    setTransformSnapConfigs(name: string, value: any): void;
    queryRectSnappingConfigs(): number | boolean | import("../../../../source/script/public/gizmos/utils/rect-transform-snapping").IRectSnapConfigData;
    ...
    applyAnimationOperation(operationList: IAnimOperation[], options?: AnimationOperationOptions): Promise<import("../../../public").IAniResultBase>;
    ...
    getCurrentFacade(): import("../../../../source/script/3d/facade/scene-facade-state-interface").ISceneFacadeState;
    /**
...
declare global {
    export namespace cce {
        ...
        let NeedAnimState: typeof import('../../../../source/script/3d/manager/engine')['NeedAnimState'];
        ...
        let ThumbnailManager: typeof import('../../../../source/script/3d/manager/thumbnail/index')['default'];
        namespace Dump {
