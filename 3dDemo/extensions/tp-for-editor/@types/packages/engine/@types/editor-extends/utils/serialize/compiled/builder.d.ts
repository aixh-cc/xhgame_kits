...
import { Node, IRefsBuilder, TraceableDict } from '../../../../../source/editor-extends/utils/serialize/compiled/types';
import { PropertyOptions, IArrayOptions, IClassOptions, ICustomClassOptions, IObjParsingInfo } from '../../../../../source/editor-extends/utils/serialize/parser';
import D = deserialize.Internal;
declare type Empty = D.Empty_;
import File = D.File_;
declare type IFileData = D.IFileData_;
declare type IRefs = D.IRefs_;
import { Builder, IBuilderOptions } from '../../../../../source/editor-extends/utils/serialize/base-builder';
